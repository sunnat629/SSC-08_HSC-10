 ...
 * @param professionCity contains the name of the city where user works
 * @param professionCountry contains the name of the country where user works
 * */
data class Profession(
    ...
    val professionCity: String,
    val professionCountry: String
)